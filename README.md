...
Le projet est composé d'un backend Node.js/Express (TypeScript) et d'un frontend en HTML/CSS/JS pur, servi directement par le backend.
...
> Le frontend n'a pas de dépendances à installer : il est servi automatiquement par Express en tant que fichiers statiques.
